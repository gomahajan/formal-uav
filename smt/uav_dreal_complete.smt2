...
;template
(assert (= p0 0.0))
(assert (= p1 2.259370327847344))
(assert (= p2 11.0))
(assert (= p3 1.0))

(assert (and (not (>= (^ 1.0e-2 2.0) (+ (^ (- bi 11.0) 2.0) (^ (- qi 9.439334531947226) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (^ (- bi 11.0) 2.0) (^ (- qi 8.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (^ (- bi 11.0) 2.0) (^ (- qi 9.258669481836826) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (^ (- bi 11.0) 2.0) (^ (- qi 8.999999987775999) 2.0))))))
;sample (assert (= p0 1))
;sample (assert (= p1 1))
;sample (assert (= p2 1))
;sample (assert (= p3 1))
