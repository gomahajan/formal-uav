...
(assert (or (and (>= bi 16.998046875) (<= qi 1.0)) (or (and (>= bi 16.99609375) (<= qi 1.0)) (or (and (>= bi 16.9921875) (<= qi 1.0)) (or (and (>= bi 16.984375) (<= qi 1.0)) (or (and (>= bi 16.96875) (<= qi 1.0)) (or (and (>= bi 16.9375) (<= qi 1.0)) (or (and (>= bi 16.875) (<= qi 1.0)) (or (and (>= bi 16.75) (<= qi 1.0)) (or (and (>= bi 16.5) (<= qi 1.0)) (or (and (>= bi 15.0) (<= qi 1.0)) (and (>= bi 20.0) (<= qi 4.0)))))))))))))
;charging
(assert(= x0 0))
...
;goal
(assert (or (<= b0 0) (<= b1 0) (<= b2 0) (<= b3 0) (>= q0 100) (>= q1 100) (>= q2 100) (>= q3 100) (not (or (and (>= b3 16.998046875) (<= q3 1.0)) (or (and (>= b3 16.99609375) (<= q3 1.0)) (or (and (>= b3 16.9921875) (<= q3 1.0)) (or (and (>= b3 16.984375) (<= q3 1.0)) (or (and (>= b3 16.96875) (<= q3 1.0)) (or (and (>= b3 16.9375) (<= q3 1.0)) (or (and (>= b3 16.875) (<= q3 1.0)) (or (and (>= b3 16.75) (<= q3 1.0)) (or (and (>= b3 16.5) (<= q3 1.0)) (or (and (>= b3 15.0) (<= q3 1.0)) (and (>= b3 20.0) (<= q3 4.0)))))))))))))))
(check-sat)
(exit)
