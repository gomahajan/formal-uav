...
;template
(assert (= p0 1.0))
(assert (= p1 9.118144234978523))
(assert (= p2 1.000537050741855))
(assert (= p3 1.0))
(assert (= p4 1.0))
(assert (= p5 10.0))
(assert (= p6 30.0))
...
(assert (and (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 6.289222031798658) 2.0)) (^ (- s2_qi 7.289222031798658) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 5.30773463844025) 2.0)) (^ (- s2_qi 7.480748783659894) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 5.407320933915983) 2.0)) (^ (- s2_qi 6.485719854556113) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 4.740964934836032) 2.0)) (^ (- s2_qi 5.740637789822251) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 3.779419250865362) 2.0)) (^ (- s2_qi 5.466476825819736) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 3.505032264185001) 2.0)) (^ (- s2_qi 4.505032264184997) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 2.509953557584724) 2.0)) (^ (- s2_qi 4.604119940869433) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 2.609041234269156) 2.0)) (^ (- s2_qi 3.609041234269156) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 1.614073534819143) 2.0)) (^ (- s2_qi 3.70923742706682) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 1.713675664129325) 2.0)) (^ (- s2_qi 2.714210082800906) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 0.7185736139817145) 2.0)) (^ (- s2_qi 2.813063053378533) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 0.8181281249999997) 2.0)) (^ (- s2_qi 1.81804375) 2.0)))) (not (>= (^ 1.0 2.0) (+ (+ (^ (- bi 30.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 10.0) 2.0))))))
;sample (assert (= p0 1))
;sample (assert (= p1 1))
;sample (assert (= p2 1))
;sample (assert (= p3 1))
