...
;template
(assert (= p0 0.0))
(assert (= p1 7.708191157078317))
(assert (= p2 11.53061224489794))
(assert (= p3 2.500014150588232))

(assert (and (not (>= (^ 1.0 2.0) (+ (^ (- bi 10.70742845664116) 2.0) (^ (- qi 7.707417150389244) 2.0)))) (not (>= (^ 1.0 2.0) (+ (^ (- bi 10.00064705600962) 2.0) (^ (- qi 6.999998790530904) 2.0)))) (not (>= (^ 1.0 2.0) (+ (^ (- bi 10.0) 2.0) (^ (- qi 8.5) 2.0))))))
;sample (assert (= p0 1))
;sample (assert (= p1 1))
;sample (assert (= p2 1))
;sample (assert (= p3 1))
