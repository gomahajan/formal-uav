...
;template
(assert (= p0 99.9921875))
(assert (= p1 3.90625e-3))
(assert (= p2 0.0))
(assert (= p3 99.9921875))
(assert (= p4 0.0))
(assert (= p5 3.90625e-3))
(assert (= p6 99.9921875))
(assert (= p7 1.0))
(assert (= p8 1.0))
(assert (= p9 1.0))

(assert (and (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.99906936810227) 2.0) (^ (- s1_qi 7.141355227671287e-3) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.9921875) 2.0) (^ (- s1_qi 1.11112568144111e-2) 2.0)) (^ (- s2_qi 1.11112568144111e-2) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.99569154685673) 2.0) (^ (- s1_qi 2.147904416618748e-3) 2.0)) (^ (- s2_qi 7.516826491936099e-3) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.990234375) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.94140625) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 9.765625e-4) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.84375) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 99.0625) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 9.765625e-4) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 97.5) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 85.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 81.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 78.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 75.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 72.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 69.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 66.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 63.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 60.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 0.0) 2.0)))) (not (>= (^ 1.0e-2 2.0) (+ (+ (^ (- bi 10.0) 2.0) (^ (- s1_qi 0.0) 2.0)) (^ (- s2_qi 9.0) 2.0))))))
;sample (assert (= p0 1))
;sample (assert (= p1 1))
;sample (assert (= p2 1))
;sample (assert (= p3 1))
