...
(assert (or (=> (> b1_14 p9) (= b2_14 p9)) (or (= s1_q2_14 0) (= s2_q2_14 0))))
(assert (=> (<= b1_14 p9) (= b2_14 b1_14)))
...
; Add (assert (and (= bc_14 30.0) (= s1_qc_14 6.189565543353948) (= s2_qc_14 8.284227979729577))) here
(assert (and (= bc_14 30.0) (= s1_qc_14 6.189565543353948) (= s2_qc_14 8.284227979729577)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_13 p9) (= b2_13 p9)) (or (= s1_q2_13 0) (= s2_q2_13 0))))
(assert (=> (<= b1_13 p9) (= b2_13 b1_13)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_13 30.0) (= s1_qc_13 6.289222031798658) (= s2_qc_13 7.289222031798658))) here
(assert (and (= bc_13 30.0) (= s1_qc_13 6.289222031798658) (= s2_qc_13 7.289222031798658)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_12 p9) (= b2_12 p9)) (or (= s1_q2_12 0) (= s2_q2_12 0))))
(assert (=> (<= b1_12 p9) (= b2_12 b1_12)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_12 30.0) (= s1_qc_12 5.30773463844025) (= s2_qc_12 7.480748783659894))) here
(assert (and (= bc_12 30.0) (= s1_qc_12 5.30773463844025) (= s2_qc_12 7.480748783659894)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_11 p9) (= b2_11 p9)) (or (= s1_q2_11 0) (= s2_q2_11 0))))
(assert (=> (<= b1_11 p9) (= b2_11 b1_11)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_11 30.0) (= s1_qc_11 5.407320933915983) (= s2_qc_11 6.485719854556113))) here
(assert (and (= bc_11 30.0) (= s1_qc_11 5.407320933915983) (= s2_qc_11 6.485719854556113)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_10 p9) (= b2_10 p9)) (or (= s1_q2_10 0) (= s2_q2_10 0))))
(assert (=> (<= b1_10 p9) (= b2_10 b1_10)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_10 30.0) (= s1_qc_10 4.740964934836032) (= s2_qc_10 5.740637789822251))) here
(assert (and (= bc_10 30.0) (= s1_qc_10 4.740964934836032) (= s2_qc_10 5.740637789822251)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_9 p9) (= b2_9 p9)) (or (= s1_q2_9 0) (= s2_q2_9 0))))
(assert (=> (<= b1_9 p9) (= b2_9 b1_9)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_9 30.0) (= s1_qc_9 3.779419250865362) (= s2_qc_9 5.466476825819736))) here
(assert (and (= bc_9 30.0) (= s1_qc_9 3.779419250865362) (= s2_qc_9 5.466476825819736)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_8 p9) (= b2_8 p9)) (or (= s1_q2_8 0) (= s2_q2_8 0))))
(assert (=> (<= b1_8 p9) (= b2_8 b1_8)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant => safety is maintained
; Add (assert (and (= bc_8 30.0) (= s1_qc_8 3.505032264185001) (= s2_qc_8 4.505032264184997))) here
(assert (and (= bc_8 30.0) (= s1_qc_8 3.505032264185001) (= s2_qc_8 4.505032264184997)))
...
;program: empty queue till battery <= 4
(assert (or (=> (> b1_7 p9) (= b2_7 p9)) (or (= s1_q2_7 0) (= s2_q2_7 0))))
(assert (=> (<= b1_7 p9) (= b2_7 b1_7)))
...
;goal
;Question: Does there exist parameters such that given battery,queue values, invariant