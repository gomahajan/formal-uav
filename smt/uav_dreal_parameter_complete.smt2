...
(assert (< (+ (* (- p0 9.0) (- p0 9.0)) (+ (* (- p1 9.0) (- p1 9.0)) (+ (* (- p2 10.0) (- p2 10.0)) (+ (* (- p3 1.0) (- p3 1.0)) (+ (* (- p4 9.0) (- p4 9.0)) (+ (* (- p5 9.0) (- p5 9.0)) (+ (* (- p6 10.0) (- p6 10.0)) (+ (* (- p7 1.0) (- p7 1.0)) (+ (* (- p8 9.0) (- p8 9.0)) (* (- p9 9.0) (- p9 9.0))))))))))) 0.0001))
